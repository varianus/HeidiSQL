...
var
  ...
  ImageIndexes: TList<Integer>;
begin
  VT := TLazVirtualStringTree(Sender);
...
begin
  ...
  VT.GetHitTestInfoAt(Mouse.CursorPos.X-VT.ClientOrigin.X, Mouse.CursorPos.Y-VT.ClientOrigin.Y, True, {%H-}Click);
...
procedure TfrmTableEditor.vtHandleClickOrKeyPress(Sender: TLazVirtualStringTree;
  Node: PVirtualNode; Column: TColumnIndex; HitPositions: THitPositions);
var
  Col: PTableColumn;
  VT: TLazVirtualStringTree;
